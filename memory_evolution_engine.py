...
try:
    from protection_utils import is_protected_content, get_protection_reason, get_all_protected_items
...
try:
    from CONSCIOUSNESS_MEMORY import MemoryBridge, check_evolution_ready
