...
from sofia.core.CURIOSITY_MOTIVATION import CuriosityEngine as _BaseCuriosityEngine
...
try:
    ...
    from sofia.core.CURIOSITY_MOTIVATION import CuriosityMotivationSystem
except ImportError:
