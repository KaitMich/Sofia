...
class VectorSymbolSystem:
    ...
    def __init__(self, encoder_model="all-MiniLM-L6-v2", data_dir="data"):
        self.encoder = SentenceTransformer(encoder_model, device=_gpu_config.get_device_str())
    ...
    def _initialize_ancient_symbols(self):
        ...
        ancient_symbols = []  # Symbols must be discovered through learning, not hardcoded
