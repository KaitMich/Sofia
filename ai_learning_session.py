...
if __name__ == "__main__":
    ...
    # Learning is now driven by seed coordinates and curiosity, not hardcoded URLs.
    # To start Sofia's first learning session:
    #   from enhanced_autonomous_learner import activate_seed_coordinates
    #   result = activate_seed_coordinates()
    # See data/seed_coordinates_manifest.json for available seeds.
    # See docs/SOPHIA_TRUTH_FRAMEWORK.md for the learning spiral philosophy.
    print("Learning system ready.")
    print("Use activate_seed_coordinates() for first session.")
    print("Use start_massive_web_learning(seed_urls=None) for curiosity-driven sessions.")