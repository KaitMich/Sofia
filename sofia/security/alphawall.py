...
from sofia.utils.vector_engine import encode_with_minilm, fuse_vectors
...
class AlphaWall:
    ...
    This is the upgraded version combining the best of:
    - Original alphawall.py (basic firewall)
    - adaptive_alphawall.py (learning system)
    - unified_alphawall.py (smart quarantine & text jumbling)
    """
...
def create_unified_alphawall():
    """Create instance for integration (backward compatibility)"""
    return AlphaWall()


# Test the system
if __name__ == "__main__":
    print("🧪 Testing AlphaWall (Unified Version)...")
    ...
    print("\n✅ AlphaWall (Unified Version) test complete!")