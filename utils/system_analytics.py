...
# Optional user_memory import for enhanced functionality
try:
    ...
    print("[INFO] user_memory not available, some user-specific analytics disabled")
...
def plot_symbol_popularity_timeline(occurrence_log_path=OCCURRENCE_LOG_PATH_SA, top_n_symbols=7):
    ...
    if USER_MEMORY_AVAILABLE:
        ...
        try:
            with open(occurrence_log_path, 'r', encoding='utf-8') as f:
                entries = json.load(f)
